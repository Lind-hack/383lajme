...
export const TOPICS = [
  {
    ...
    "matchGroups": [["dialogu"],["kosove","serbi"],["bruksel","normalizim"],["bruksel","normalizimin"],["ohri"],["asociacioni"],["asociacionin"],["banjska"],["targat"],["dinar"],["kurti","vucic"],["kurti","petkovic"],["lajcak","dialogu"]],
    "anchors": [
      "dialogu kosove serbi",
      "kosove serbi",
      "kosova serbia",
