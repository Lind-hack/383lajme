...
export const KOSOVO_CITIES: readonly KosovoCity[] = [
  ...
  },
  {
    ...
    places: [
      ...
      { name: "Liqeni i Ujmanit", category: "Ekskursion", description: "Një dalje panoramike drejt ujit dhe kodrave në veri të rajonit. Kontrollo rrugën dhe kushtet lokale para nisjes.", visitHint: "3-5 orë", mapsQuery: "Ujman Gazivoda Lake Kosovo", image: "/visit/places/mitrovice-ujman.webp", imageAlt: "Liqeni i Ujmanit i parë nga ajri", imageSourceUrl: "https://commons.wikimedia.org/wiki/File:Ujemani_or_Gazivoda_Lake_as_seen_from_the_Air.jpg", imageCredit: "SUHEJLO", imageLicense: "CC BY 4.0" },
    ],
  },
  {
    id: "gjilan",
