...
test("the rotation is the same on every machine, whatever its timezone", () => {
  // 2026-08-18 is day 230, so index 230 % 30 = 20. Local-time arithmetic in a
  // DST zone yields 229 and index 19 — the previous day's question.
  assert.equal(getDefaultPoll("2026-08-18").question, POLL_QUESTIONS[20].question);
});
