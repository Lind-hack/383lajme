...
export const DRAFT_SYSTEM_PROMPT = [
  ...
  "Shkruaj një pyetje TË VETME në shqip, bazuar në lajmet e sotme, që i ndan lexuesit vërtet përgjysmë.",
  "",
  "Rregulla:",
  "- Pyetja duhet të jetë e diskutueshme: nëse përgjigjja është e qartë për shumicën, nuk vlen.",
  "- Lidhu me një ngjarje konkrete të sotme, jo me një temë të përgjithshme.",
  "- 2 deri 4 opsione, secili nën 44 karaktere, të shkurtra dhe të qarta.",
  "- Opsionet duhet të jenë reale: asnjë 'Nuk e di'.",
  "- Pyetja mbaron me pikëpyetje dhe është nën 140 karaktere.",
  "- context_line: një fjali që thotë çfarë ndodhi sot dhe pse pyetja bëhet sot.",
  "- source_article_slug: slug-u i artikullit që e mbështet, ose null.",
  "",
  'Kthe VETËM JSON: {"question":"...","options":["...","..."],"context_line":"...","source_article_slug":"..."}',
].join("\n");
