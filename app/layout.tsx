...
// Soft, rounded geometric face for the nav category links — gentler
// letterforms than Manrope, distinctive against the sharp "383" wordmark.
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="sq" className={`${manrope.variable} ${quicksand.variable}`} style={{ background: "#F9F6F1" }}>
      <head>
