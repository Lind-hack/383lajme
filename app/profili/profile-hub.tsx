...
export default function ProfileHub({ identity, savedArticles: initialSaved, tregu, dataUnavailable, profileUnavailable }: {
  ...
  return <main className={styles.page}><div className={styles.shell}>
    ...
    <section id="tregu" className={`${styles.section} ${styles.treguSection}`}>
      <div className={styles.sectionHeading}><div><h2>383 Monedha dhe tregtimet</h2><p>Bilanci, lëvizja 30-ditore dhe aktiviteti yt më i fundit.</p></div><Link className={styles.primaryLink} href="/tregu/portofoli">Hap portofolin <ArrowRight size={15} aria-hidden /></Link></div>
